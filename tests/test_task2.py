...
def test_world_cities_api_response_content(run_program):
    ...
    assert search_str_in_file(os.path.abspath(os.path.join(app.Config.BASE_DIR, '..', 'logs', 'world_cities_api_response.log')), 'Paris') == True
